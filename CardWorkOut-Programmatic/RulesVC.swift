...
//
//  Created by Joel Gaspar on 11/09/20.
...
class RulesVC: UIViewController {
    ...
    func configureRulesLabel(){
        ...
        NSLayoutConstraint.activate([
            ...
            rulesLabel.leadingAnchor.constraint(equalToSystemSpacingAfter: view.leadingAnchor, multiplier: 30),
            rulesLabel.trailingAnchor.constraint(equalToSystemSpacingAfter: view.trailingAnchor, multiplier: -30)
